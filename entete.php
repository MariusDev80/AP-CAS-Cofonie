						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="index.php?vue=signup&action=signup" method="post">
									<div class="mb-3">
										<label for="username" class="form-label">Nom d'utilisateur</label>
										<input type="text" class="form-control" id="username" name="signupUsername" placeholder="Entrez votre nom d'utilisateur" required>
									</div>
									<div class="mb-3">
										<label for="password" class="form-label">Mot de passe</label>
										<input type="password" class="form-control" id="password" name="signupPassword" placeholder="Entrez votre mot de passe" required>
									</div>
									<div class="mb-3">
